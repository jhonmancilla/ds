...
<?php
        ...
        <!-- JS Verificacion para eliminar un usuario -->
<div class="container" style="justify-content: center;align-items: center;display: flex;height: 15vh;">
        ...
        <table class="table" width="500px" border="=1">
            ...
            <td><a href="eliminar-programa.php?pro_codigo=<?php echo $mostrar['pro_codigo']?>"><i class="fas fa-trash-alt" onclick="return ConfirmDelete()"></i></a></td>
