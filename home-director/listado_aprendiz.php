  ...
  <table class="table" style="border: solid 2px;">
    ...
    while ($row = mysqli_fetch_assoc($resultado)) { ?>
      <tr>
        ...
        <td><a href="actualizar-aprendiz.php?apr_id=<?php echo $row['apr_id']?>"><i class="far fa-edit"></i></a></td>
