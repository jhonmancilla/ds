...
<html lang="es" dir="ltr">
  ...
  <body>
    ...
    <!-- /Conetcion con Bootstrap  -->
    <div class="container">
      <form action="validar-actualizar-matricula.php" method="post">
      <table class="table">
        <tr>
          <th>Codigo de la matricula</th>
      ...
      <?php
      $id = $_GET['id'];
      $consulta="SELECT * FROM matricula WHERE num_matricula = '$id'";
      $result=mysqli_query($conexion,$consulta);
        while($mostrar=mysqli_fetch_array($result)){
        ?>
        <tr>
          <input type="hidden" name="id" value="<?php echo $mostrar['num_matricula']?>">
          <td><input type="text" name="num_matricula" value="<?php echo $mostrar['num_matricula']?>"></td>
          <td><input type="text" name="mat_estado" value="<?php echo $mostrar['mat_estado']?>"></td>
          <td><input type="text" name="fic_numero" value="<?php echo $mostrar['fic_numero']?>"></td>
          <td><input type="text" name="apr_id" value="<?php echo $mostrar['apr_id']?>"></td>
